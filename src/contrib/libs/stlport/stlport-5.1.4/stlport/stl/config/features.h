...
#if defined(__GNUC__)
    #define _STLP_UNUSED_TYPEDEF __attribute__((unused))
#else
    #define _STLP_UNUSED_TYPEDEF
#endif
 ...
 */
#  define _STLP_STATIC_ASSERT(expr) typedef char __static_assert[expr ? 1 : -1] _STLP_UNUSED_TYPEDEF;
#endif
...
#  if defined (_STLP_USE_NAMESPACES) && (defined(_STLP_USE_OWN_NAMESPACE) || defined (_STLP_VENDOR_GLOBAL_CSTD)) && !defined(_STLP_DONT_REDEFINE_STD)
...
#    define _STLP_PRIV_NAME NStlPriv
