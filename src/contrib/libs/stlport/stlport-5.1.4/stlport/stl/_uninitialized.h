...
inline void uninitialized_fill_n(unsigned char* __first, _Size __n,
                                 const unsigned char& __val) {
  unsigned char __tmp = __val;
  memset(__first, __tmp, __n);
}
#if !defined (_STLP_NO_SIGNED_BUILTINS)
template <class _Size>
inline void uninitialized_fill_n(signed char* __first, _Size __n,
                                 const signed char& __val) {
  signed char __tmp = __val;
  memset(__first, __STATIC_CAST(unsigned char,__tmp), __n);
}
#endif
template <class _Size>
inline void uninitialized_fill_n(char* __first, _Size __n, const char& __val) {
  char __tmp = __val;
  memset(__first, __STATIC_CAST(unsigned char,__tmp), __n);
}
