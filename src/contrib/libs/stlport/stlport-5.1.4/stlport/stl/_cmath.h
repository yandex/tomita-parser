...
#if defined (_STLP_USE_NEW_C_HEADERS) && !defined(_darwin_)
...
inline float ldexpf(float x, float y) {
...
#if (defined (_STLP_MSVC) && !defined (_STLP_WCE)) && (_STLP_MSVC < 1800) || defined (__ICL) || defined (__sun)
