...
#pragma GCC diagnostic ignored "-Warray-bounds" // gcc 4.6+ can't cope with __stl_threshold
...
#if defined (__GNUC__) && (__GNUC__ * 10000 + __GNUC_MINOR__ * 100 + __GNUC_PATCHLEVEL__ > 40600)
#pragma GCC diagnostic pop // diagnostic ignored "-Warray-bounds"
#endif
