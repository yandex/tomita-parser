...
#if defined(_STLP_USE_DEFAULT_FILE_OFFSET) || defined(_darwin_)
#  define FOPEN fopen
#  define FSEEK fseek
#  define FSTAT fstat
#  define STAT  stat
...
#  define MMAP  mmap
#  define OPEN  open
#elif !defined(__FreeBSD__) && (defined(_LARGEFILE_SOURCE) || defined(_LARGEFILE64_SOURCE)) /* || defined(__USE_FILE_OFFSET64) */ \
...
#  pragma unused(fd)
 ...
 LARGE_INTEGER li;
 li.LowPart = GetFileSize(fd, (LPDWORD) &li.HighPart);
