...
// Solaris interface looks to be identical.
    ...
    ( defined(__sgi) || \
      ...
      (defined (_STLP_MSVC) && !defined (_STLP_WCE_EVC3)) || \
        defined (__ICL) || defined (__MINGW32__) || defined(__DJGPP) || defined (_AIX) || defined (_CRAY) || defined(__WINE__))

#if defined (_STLP_MSVC) || defined (__ICL) || defined (__MINGW32__) || defined(__DJGPP) || defined(__WINE__)
