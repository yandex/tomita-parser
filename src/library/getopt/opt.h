...
private:
    ...
    void Init(int argc, char* argv[], const char* optString, const Ion* longOptions = 0, bool longOnly = false, bool isOpen = false);

public:
    Opt(int argc, char* argv[], const char* optString, const Ion* longOptions = 0, bool longOnly = false, bool isOpen = false);
    Opt(int argc, const char* argv[], const char* optString, const Ion* longOptions = 0, bool longOnly = false, bool isOpen = false);
