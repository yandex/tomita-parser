...
template <bool quote, bool tounicode>
inline void EscapeJ(TStringBuf in, Stroka& out, TStringBuf safe = TStringBuf(), TStringBuf unsafe = TStringBuf()) {
    TTempBuf b(SuggestBuffer(+in) + 2);
...
template <bool quote, bool tounicode>
inline Stroka EscapeJ(TStringBuf in, TStringBuf safe = TStringBuf(), TStringBuf unsafe = TStringBuf()) {
    Stroka s;
