...
TSplitDelimitersBit::TSplitDelimitersBit(const char* s)
{
    Delims[0] = Delims[1] = Delims[2] = Delims[3] = Delims[4] = Delims[5] = Delims[6] = Delims[7] = 0;
    while (*s)
    {
        ui8 value = (ui8)*s;
        Delims[value >> 5] |= (1 << (value & 31));
        ++s;
    }
}
...
/****************** TSplitBase ******************/
TSplitBase::TSplitBase(const char* str, size_t length) : Str(str), Len(length)
{

}

TSplitBase::TSplitBase(const Stroka& s) : Str(~s), Len(+s)
{
...
TDelimitersSplit::TDelimitersSplit(const char* str, size_t length, const TSplitDelimiters& delimiters) : TSplitBase(str, length), Delimiters(delimiters)
{

}

TDelimitersSplit::TDelimitersSplit(const Stroka& s, const TSplitDelimiters& delimiters) : TSplitBase(s) , Delimiters(delimiters)
{
...
TDelimitersStrictSplit::TDelimitersStrictSplit(const char* str, size_t length, const TSplitDelimiters& delimiters) : TSplitBase(str, length), Delimiters(delimiters)
{

}

TDelimitersStrictSplit::TDelimitersStrictSplit(const Stroka& s, const TSplitDelimiters& delimiters) : TSplitBase(s), Delimiters(delimiters)
{
...
TScreenedDelimitersSplit::TScreenedDelimitersSplit(const Stroka& s, const TSplitDelimiters& delimiters, const TSplitDelimiters& screens)
    : TSplitBase(s)
...
TDelimitersSplitWithoutTags::TDelimitersSplitWithoutTags(const char* str, size_t length, const TSplitDelimiters& delimiters) : TSplitBase(str, length), Delimiters(delimiters)
{

}

TDelimitersSplitWithoutTags::TDelimitersSplitWithoutTags(const Stroka& s, const TSplitDelimiters& delimiters) : TSplitBase(s) , Delimiters(delimiters)
{
...
TCharSplit::TCharSplit(const char* str, size_t length) : TSplitBase(str, length)
{

}

TCharSplit::TCharSplit(const Stroka& s) : TSplitBase(s)
{
...
TCharSplitWithoutTags::TCharSplitWithoutTags(const Stroka& s)
    : TSplitBase(s)
{
...
TSubstringSplitDelimiter::TSubstringSplitDelimiter(const Stroka& s)
    : Matcher(s)
    , Len(+s)
{
}
...
TSubstringSplit::TSubstringSplit(const Stroka& str, const TSubstringSplitDelimiter& delimiter)
    : TSplitBase(str)
    , Delimiter(delimiter)
{
}
