...
namespace NCharsetInternal {
    ...
    const TScriptRange ScriptRanges[] = {
        ...
        { SCRIPT_ARABIC, 0x656, 0x65F },
        { SCRIPT_ARABIC, 0x66A, 0x66F },
        { SCRIPT_ARABIC, 0x671, 0x6DC },
        { SCRIPT_ARABIC, 0x6DE, 0x6FF },
        { SCRIPT_ARABIC, 0x750, 0x77F },
        { SCRIPT_ARABIC, 0x8A0, 0x8B2 },
        { SCRIPT_ARABIC, 0x8E4, 0x8FF },
        ...
        { SCRIPT_MALAYALAM, 0xD4A, 0xD4E },
        { SCRIPT_MALAYALAM, 0xD57, 0xD57 },
        { SCRIPT_MALAYALAM, 0xD60, 0xD63 },
        { SCRIPT_MALAYALAM, 0xD66, 0xD75 },
        { SCRIPT_MALAYALAM, 0xD79, 0xD7F },
        ...
        { SCRIPT_CYRILLIC, 0xA640, 0xA69D },
        { SCRIPT_CYRILLIC, 0xA69F, 0xA69F },
        { SCRIPT_DEVANAGARI, 0x900, 0x950 },
        { SCRIPT_DEVANAGARI, 0x953, 0x963 },
        { SCRIPT_DEVANAGARI, 0x966, 0x97F },
        { SCRIPT_DEVANAGARI, 0xA8E0, 0xA8FB },
        ...
        { SCRIPT_LATIN, 0xA78B, 0xA78E },
        { SCRIPT_LATIN, 0xA790, 0xA7AD },
        { SCRIPT_LATIN, 0xA7B0, 0xA7B1 },
        { SCRIPT_LATIN, 0xA7F7, 0xA7FF },
        { SCRIPT_LATIN, 0xAB30, 0xAB5A },
        { SCRIPT_LATIN, 0xAB5C, 0xAB5F },
        { SCRIPT_LATIN, 0xAB64, 0xAB64 },
    ...
    void InitScriptData(ui8 data[], size_t len) {
        ...
        for (size_t i = 0; i < ARRAY_SIZE(ScriptRanges); ++i) {
            const TScriptRange& range = ScriptRanges[i];
            YASSERT(range.Start <= range.End);
            YASSERT((unsigned)range.Script < 0x100);
